...
prop_functorWithId ints =
  let
    tree1 = foldl addValue MyTreeEmpty ints
    tree2 = fmap id tree1
  in
    tree1 == tree2
...
prop_functorCommutative ints =
  let
    func1 = (\i -> i + 1)
    func2 = (\i -> i * 2)
    tree1 = fmap (func1 . func2) $ foldl addValue MyTreeEmpty ints
    tree2 = fmap func1 $ fmap func2 $ foldl addValue MyTreeEmpty ints
  in
    tree1 == tree2
